...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(compress(new char[]{'x','7','7','2','2','2','f','\'','\'',
                        ...
                        ',',',','Y',':','w','.','q',')',')','0','0','0','0','{','E',
                        'E','E','E',';','>','{','{',']',']','h','b','A','A','A','H',
                        't','6','6','6','6','E','E','i','V','V','V','V','X','F',',','/',
                        '/','X','2','2','Z','Z','z','z','o','x','x','F','F','F','v','v',
                        'v','v','v','v','/','/','/','8','8','8','8','U','y','y','y','y',
                        'y','%','X','%','%','%','@','@','@','-',')','I','4','4','^','{',
                        '7','h','@','/','/','^','^','V','9','9','9','9','9','J','A','A',
                        '{','{','B','B','B','B','B','c','b','b','R','R','b','b','^','8',
                        '\'','\'','\'',')',')','n','n','/','e','/','/','S','Z','M','0',
                        '0','0','0','0','T','T','T',')',')','^','^','n','n',';','1','X',
                        'X','X','`','`','`','H','H','-','-','-','-','J','J','a','&','F',
                        'X','p','F','G','Y','|','v','v','=','H','G','G','G',';','m','m',
                        'm','m','h','h','h','h','M','*','*','h','K','k','k','k','k','(',
                        '(','(','B','B','B','c','c','c','c','w','3','3','3','3','3','3',
                        'B','B','}','p','p','G','x','x','=','-','<','<','<','Q','Q','&',
                        '&','J','J','J','t',']','X','d','z','z','r',';',';',';','7','7',
                        '7','f','l','e','e','e','+','+','@','@','@'}));
    }
